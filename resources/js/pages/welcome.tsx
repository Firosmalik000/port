        ...
        entries: [
            {
                ...
                location: 'East Ciputat, South Tangerang',
                bullets: [
...
const programmerExperience = [
    ...experienceTimeline[0].entries,
    ...experienceTimeline[1].entries,
];

const additionalExperience = [
    ...experienceTimeline[2].entries,
    ...experienceTimeline[3].entries,
...
export default function Welcome() {
    ...
    const profileUrl = new URL('../../../docs/profile.jpg', import.meta.url)
        .href;
    const photoUrl = new URL('../../../docs/photo.jpg', import.meta.url).href;
            ...
            <div className="relative min-h-screen overflow-hidden bg-[#f8fafc] text-[#0f172a]">
                ...
                <main className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-12 sm:px-8 sm:pb-16 lg:px-10">
                        ...
                        <div className="grid gap-8 pt-4 sm:pt-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="mt-4 overflow-hidden rounded-[1.5rem] border border-sky-100 bg-slate-100 sm:mt-5 sm:rounded-[1.75rem]">
                                        <img
                                            src={profileUrl}
                        ...
                        <div className="mt-5 mb-2">
                            <div className="flex flex-col gap-y-2 rounded-[1.5rem] border border-sky-100 bg-[linear-gradient(135deg,_rgba(239,246,255,0.95),_rgba(255,255,255,0.98))] p-5 shadow-sm sm:p-6">
                                ...
                                <p className="mt-4 text-sm leading-7 text-slate-700">
                                    Full-stack developer focused on practical
                                    interfaces, stable integrations, and cleanly
                                    delivered features.
                                </p>
                                <p className="mt-3 text-sm leading-7 text-slate-600">
                                    I enjoy building product pages that feel
                            ...
                            <div className="p-5 sm:p-6">
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <span className="rounded-full border border-sky-100 bg-sky-50 px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-sky-700 uppercase">
                                        Flat icons
                                    </span>
                                </div>
                                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4">
                                    {skills.map((skill) => (
                                        <div
                                            key={skill.name}
                                            className="rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(248,250,252,0.98))] p-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                                        >
                    ...
                    <section className="mt-8 sm:mt-10">
                        ...
                        <div className="mt-5 grid gap-4 lg:grid-cols-2">
                            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-5 shadow-sm sm:p-6">
                                <div className="flex items-center justify-between gap-3">
                                    <p className="text-[10px] tracking-[0.26em] text-slate-400 uppercase sm:text-xs sm:tracking-[0.32em]">
                                        Programmer experience
                                    </p>
                                    <span className="rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-blue-700 uppercase">
                                        Core
                                    </span>
                                </div>
                                <div className="mt-4 space-y-3">
                                    {programmerExperience.map(
                                        (entry, index) => (
                                            <motion.article
                                                ...
                                                <ul className="mt-4 grid gap-2 text-sm leading-6 text-slate-600">
                                                    {entry.bullets.map(
                                                        (bullet) => (
                                                            <li
                                                                key={bullet}
                                                                className="flex gap-3 rounded-2xl border border-slate-100 bg-white px-3 py-2"
                                                            >
                                                                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-gradient-to-br from-sky-500 to-blue-500" />
                                                                <span className="flex-1">
                                                                    {bullet}
                                                                </span>
                                                            </li>
                    ...
                    <section
                        id="projects"
                        className="relative left-1/2 mt-8 w-screen -translate-x-1/2 overflow-hidden bg-sky-100/90 py-8 sm:mt-10 sm:py-10"
                    >
                    ...
                    <section
                        id="contact"
                        className="relative mt-8 overflow-hidden rounded-[1.75rem] border border-white/50 bg-gradient-to-br from-sky-50 via-white/70 to-blue-100/60 p-4 shadow-[0_24px_70px_rgba(59,130,246,0.12)] backdrop-blur-xl sm:mt-10 sm:p-6"
                    >
                        ...
                        <div className="relative grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                            <div>
                                ...
                                <div className="mt-5 flex flex-wrap gap-3 text-sm text-slate-600">
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 rounded-full border border-white/50 bg-white/55 px-4 py-2 shadow-sm backdrop-blur-md transition hover:border-sky-200 hover:bg-white/75"
                                    >
                                    ...
                                    <span className="inline-flex items-center gap-2 rounded-full border border-white/50 bg-white/55 px-4 py-2 shadow-sm backdrop-blur-md">
                                        <MapPin className="h-4 w-4" />
                                        Ciputat Timur, South Tangerang
                                    </span>
                                </div>
                                    ...
                                    <div className="mt-3 flex flex-wrap gap-3">
                                        {socialLinks.map((link) => (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="group inline-flex items-center gap-2 rounded-full border border-white/50 bg-white/55 px-4 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur-md transition hover:border-sky-200 hover:bg-white/75"
                                            >
                                                {link.icon}
                                                {link.label}
                            ...
                            >
                                ...
                                <div className="pointer-events-none absolute -top-20 -right-16 h-40 w-40 rounded-full bg-white/60 blur-3xl" />
                                <div className="pointer-events-none absolute -bottom-20 -left-16 h-44 w-44 rounded-full bg-sky-300/30 blur-3xl" />

                                <div className="relative overflow-hidden rounded-[1.4rem] border border-white/50 bg-white/30 shadow-inner">
                                    <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/25 via-transparent to-transparent" />
                                    <img
                                        src={photoUrl}
                                        alt="Portrait of Firos Malik Abdillah"
                                        className="aspect-[4/5] w-full object-cover object-center"
                                    />
                                </div>

                                <div className="relative mt-3 flex items-center justify-between gap-3 rounded-[1.25rem] border border-white/45 bg-white/35 px-3 py-3 backdrop-blur-md">
                                    <div>
                                    ...
                                    <span className="rounded-full border border-emerald-200/70 bg-emerald-50/80 px-3 py-1 text-[11px] font-medium text-emerald-700 shadow-sm">
                                        Ready
                                    </span>
                                </div>
                            </motion.div>
